...
public class Student implements Serializable, Comparable<Student> {
    ...
    public static void main(String[] args) {
        ...
        students[0] = new Student("Nguyen Van A", "01/01/2000", "Male");
        students[1] = new Student("Nguyen Van Y", "01/01/2000", "Female");
        students[2] = new Student("Nguyen Van C", "01/01/2010", "Male");
        students[3] = new Student("Nguyen Van F", "01/01/2000", "Female");
        students[4] = new Student("Nguyen Van E", "01/01/2005", "Male");
