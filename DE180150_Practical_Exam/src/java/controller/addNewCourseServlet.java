...
public class addNewCourseServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
            ...
            String lecturerName=request.getParameter("lectureName");
            String credits=request.getParameter("credit");
            course c=new course(courseID, subject, lecturerName, Integer.parseInt(credits));
            CourseDB courseDB = new CourseDB();
            courseDB.addNew(c);
            request.setAttribute("message", "Insert new course: " + c);
